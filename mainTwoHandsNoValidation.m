...
while hasFrame(obj)
    ...
    if firstBoard.imagePoints(1,1) > -1
        ...
        data = hideCheckerboard(data,firstBoard.imagePoints);
        ...
        if secondBoard.imagePoints(1,1) > -1
            ...
            data = hideCheckerboard(data,secondBoard.imagePoints);
...
%%% TODO: Remove references to aurora ref frame!
%% Data Analysis
