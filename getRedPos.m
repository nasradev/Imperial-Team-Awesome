...
% RGB channels
levelR = graythresh(image(:,:,1));
levelG = graythresh(image(:,:,2));
levelB = graythresh(image(:,:,3));
% Saturation channel
...
for i = 1:numRed
    ...
    if (maxColor == 0 || areas(i) < 20 || areas(i) > 100)
...
% dist in mm
% blue: 105; yellow: 25; green: 130, red: 30 mm;
d1 = 30;
redArea = 0;
x1 = 0; y1 = 0;
